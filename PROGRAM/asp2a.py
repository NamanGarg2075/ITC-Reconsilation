...
def asp2a():
    ...
    if last_month_input.lower() == 'y':
        ...
        pending_last_month = pd.read_excel(last_month_path, sheet_name='PENDING',engine='openpyxl')
        extra_last_month = pd.read_excel(last_month_path, sheet_name='EXTRA',engine='openpyxl')

    # getting current month of file
    current_monn_file = pd.read_excel(b2b_path, sheet_name='Read me')['Unnamed: 4'][0][0:2]
    ...
    merged_df.rename(columns={'Gross Total_x':'2A Gross Total', 'BASIC_x':'2A BASIC', 'CGST_x':'2A CGST','SGST_x':'2A SGST', 'IGST_x':'2A IGST', 'Gross Total_y':'BOOKS Gross Total', 'BASIC_y':'BOOKS BASIC', 'CGST_y':'BOOKS CGST', 'SGST_y':'BOOKS SGST','IGST_y':'BOOKS IGST'},inplace=True)
    ...
    # Rearrancing Columns
    merged_df =  merged_df[['SUPPLIER NAME', 'GSTIN/UIN', 'Bill No', 'Month', 'Year', '2A BASIC','BOOKS BASIC', '2A CGST', 'BOOKS CGST','2A SGST','BOOKS SGST', '2A IGST', 'BOOKS IGST', 'BASIC_diff', 'CGST_diff', 'SGST_diff', 'IGST_diff','GST_diff_total']]
    ...
    main_data_df['Supplier Invoice Date'] = pd.to_datetime(main_data_df['Supplier Invoice Date'])
    ...
    pending_df.rename(columns={'Gross Total_x':'2A Gross Total', 'BASIC_x':'2A BASIC', 'CGST_x':'2A CGST','SGST_x':'2A SGST', 'IGST_x':'2A IGST', 'Gross Total_y':'BOOKS Gross Total', 'BASIC_y':'BOOKS BASIC', 'CGST_y':'BOOKS CGST', 'SGST_y':'BOOKS SGST','IGST_y':'BOOKS IGST'},inplace=True)
    ...
    extra_df.rename(columns={'Gross Total_x':'2A Gross Total', 'BASIC_x':'2A BASIC', 'CGST_x':'2A CGST','SGST_x':'2A SGST', 'IGST_x':'2A IGST', 'Gross Total_y':'BOOKS Gross Total', 'BASIC_y':'BOOKS BASIC', 'CGST_y':'BOOKS CGST', 'SGST_y':'BOOKS SGST','IGST_y':'BOOKS IGST'},inplace=True)
    ...
    # Rearrancing Columns
    pending_df =  pending_df[['SUPPLIER NAME', 'GSTIN/UIN', 'Bill No', 'Month', 'Year', '2A BASIC','BOOKS BASIC', '2A CGST', 'BOOKS CGST','2A SGST','BOOKS SGST', '2A IGST', 'BOOKS IGST', 'BASIC_diff', 'CGST_diff', 'SGST_diff', 'IGST_diff','GST_diff_total']]
    ...
    # Rearrancing Columns
    extra_df =  extra_df[['SUPPLIER NAME', 'GSTIN/UIN', 'Bill No', 'Month', 'Year', '2A BASIC','BOOKS BASIC', '2A CGST', 'BOOKS CGST','2A SGST','BOOKS SGST', '2A IGST', 'BOOKS IGST', 'BASIC_diff', 'CGST_diff', 'SGST_diff', 'IGST_diff','GST_diff_total']]
    ...
    # Renaming Columns Name
    summary_df.rename(columns={'Gross Total_x':'2A Gross Total', 'BASIC_x':'2A BASIC', 'CGST_x':'2A CGST','SGST_x':'2A SGST', 'IGST_x':'2A IGST', 'Gross Total_y':'BOOKS Gross Total', 'BASIC_y':'BOOKS BASIC', 'CGST_y':'BOOKS CGST', 'SGST_y':'BOOKS SGST','IGST_y':'BOOKS IGST'},inplace=True)
    ...
    # Calculating Difference
    summary_df['BASIC_diff'] = summary_df['2A BASIC'] - summary_df['BOOKS BASIC']
    summary_df['CGST_diff'] = summary_df['2A CGST'] - summary_df['BOOKS CGST']
    summary_df['SGST_diff'] = summary_df['2A SGST'] - summary_df['BOOKS SGST']
    summary_df['IGST_diff'] = summary_df['2A IGST'] - summary_df['BOOKS IGST']
    ...
    # Rearrancing Columns
    summary_df =  summary_df[['SUPPLIER NAME', 'GSTIN/UIN','Month','Year', '2A BASIC','BOOKS BASIC', '2A CGST', 'BOOKS CGST','2A SGST','BOOKS SGST', '2A IGST', 'BOOKS IGST', 'BASIC_diff', 'CGST_diff', 'SGST_diff', 'IGST_diff','GST_diff_total']]
    ...
    # Calculating Difference
    pending_df.loc[:,'BASIC_diff'] = pending_df.loc[:,'2A BASIC'] - pending_df.loc[:,'BOOKS BASIC']
    pending_df.loc[:,'CGST_diff'] = pending_df.loc[:,'2A CGST'] - pending_df.loc[:,'BOOKS CGST']
    pending_df.loc[:,'SGST_diff'] = pending_df.loc[:,'2A SGST'] - pending_df.loc[:,'BOOKS SGST']
    pending_df.loc[:,'IGST_diff'] = pending_df.loc[:,'2A IGST'] - pending_df.loc[:,'BOOKS IGST']
    ...
    # Calculating Difference
    extra_df.loc[:,'BASIC_diff'] = extra_df.loc[:,'2A BASIC'] - extra_df.loc[:,'BOOKS BASIC']
    extra_df.loc[:,'CGST_diff'] = extra_df.loc[:,'2A CGST'] - extra_df.loc[:,'BOOKS CGST']
    extra_df.loc[:,'SGST_diff'] = extra_df.loc[:,'2A SGST'] - extra_df.loc[:,'BOOKS SGST']
    extra_df.loc[:,'IGST_diff'] = extra_df.loc[:,'2A IGST'] - extra_df.loc[:,'BOOKS IGST']
